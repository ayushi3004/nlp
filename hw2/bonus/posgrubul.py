...
Original file is located at
    https://colab.research.google.com/drive/1mGdplwBOdaVNYx3paGYA9uVDvuKlRR_R
"""
...
def train_model(X_train, Y_train, weights, VOC_LEN):
  ...
  gru_model.compile(loss  =  l,
              optimizer =  opt,
              metrics   =  ['acc'])
  gru_model.fit(X_train, Y_train, callbacks=[callback], batch_size=100, epochs=20)
  return gru_model
...
TRAIN_TAG_FILE = "/content/drive/My Drive/nlp_files/hw2/btb.train.tgs"
TRAIN_TOKEN_FILE = "/content/drive/My Drive/nlp_files/hw2/btb.train.txt"
TEST_TAG_FILE = "/content/drive/My Drive/nlp_files/hw2/btb.test.tgs"
TEST_TOKEN_FILE = "/content/drive/My Drive/nlp_files/hw2/btb.test.txt"
